...
FlashPlayer.getInstance = function(options) {
  ...
  return FlashPlayer.instance;
};

FlashPlayer.prototype.initialize = function(cfg) {
  ...
  this.bind('error', this._onError);
  this.bind('durationchange', this._onDurationChange);
};

FlashPlayer.prototype._setupFlashContainer = function() {
  this.flashContainer = document.createElement("div");
  this.flashContainer.setAttribute("id", "playerFlashContainer");
...
FlashPlayer.prototype._checkForFlashBlock = function() {
...
FlashPlayer.prototype._onInitialized = function(e) {
...
FlashPlayer.prototype._showFlashRequiredDialog = function() {
...
FlashPlayer.prototype._loadFlash = function() {
  ...
  var fv = { playerInstance: 'window.flashPlayer' };
  swfobject.embedSWF(this.swfSrc, "playerFlashObject", "231", "141", "10.1.0", undefined, fv, {allowscriptaccess: "always"}, undefined, bind(this._flashLoaded, this));
};

FlashPlayer.prototype._flashLoaded = function(e) {
  if(e.success){
...
FlashPlayer.prototype.bind = function(eventName, fn){
  if(!this._events[eventName]){ this._events[eventName] = [] }
  this._events[eventName].push(fn);
};

FlashPlayer.prototype.triggerEvent = function(eventName, arg0, arg1){
...
FlashPlayer.prototype._onError = function _onError(msg) {
  if (this.onerror) {
    this.onerror(msg);
  }
};
